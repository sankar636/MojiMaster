// This is the original KenoType typing-test screen, unchanged — only moved
// out of App.jsx so App.jsx could become a router shell for the new
// /vocabulary section. Nothing about its logic, state, or markup changed.
        ...
        {testFinished ? (
          ...
          <>
            ...
            <div className="flex items-center gap-2 mt-10 text-sm text-subAlt">
              ...
              <span>
                type the romaji reading for each word · space to continue
              </span>
            </div>
