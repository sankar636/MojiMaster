...
function makeWord(script) {
  ...
  const useKata =
    script === 'katakana' || (script === 'mixed' && Math.random() < 0.5);
  return {
...
const KanaType = () => {
  ...
  return (
    <div
      className="w-full min-h-160 flex flex-col items-center px-6 py-8 select-none"
      style={{
      ...
      <div className="w-full max-w-3xl flex-1 flex flex-col items-center">
        ...
        {!testActive && !testFinished && (
          ...
          >
            ...
            <div
              className="w-px h-4"
              style={{ backgroundColor: COLORS.subAlt }}
            />
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                style={{
                  backgroundColor: COLORS.bg,
                  color: COLORS.text,
                  border: `1px solid ${COLORS.subAlt}`,
                }}
              />
            </div>
          </div>
        ...
        {testActive && (
          <div
            className="w-full mb-8 font-mono text-3xl"
        ...
        {testFinished ? (
          <div className="w-full flex flex-col items-center gap-8 py-10 animate-[fadeIn_0.3s_ease]">
            ...
            <div
              className="flex gap-10 font-mono text-sm"
          ...
          <>
            ...
            <div
              ref={scrollRef}
              className="w-full h-55 overflow-hidden leading-[2.6rem] text-2xl"
            >
